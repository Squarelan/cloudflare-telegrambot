D1 数据库版本 | [KV 版本](https://github.com/dhd2333/cloudflare-telegrambot/blob/main/Readme.md)

# 消息转发机器人 - D1 数据库版本


> 💡 **版本说明**：本文档为 D1 数据库版本（`worker_D1.js`）的部署指南。如果你是小规模使用或初次部署，建议使用 [KV 版本](https://github.com/dhd2333/cloudflare-telegrambot/blob/main/Readme.md)（`worker.js`），部署更简单。
